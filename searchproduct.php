...
<body style="background:wheat">
    ...
    <nav class="navbar">
        ...
        <form action="allproduct.php" method="POST" class="search_bar">
        ...
        if(isset($_POST['search'])) {
            $searchq = mysqli_real_escape_string($con, $_POST['submit-search']);
            $sql = "SELECT * FROM users WHERE name LIKE '%$searchq%' OR location LIKE '%$searchq%'";
