...
<body>
        ...
        <a href="#home"><img class="img-logo1" src="logo1.jpeg"></a>
            ...
            <ul class="navbar__menu">
                ...
                <li class="navbar__btn">
                    ...
                    &nbsp;
                    <a href="login.php" class="button2" id=login>Login</a>
                </li>
            </ul>
        </div>
    </nav>  
    ...
    <div class="hero" id="home">
        <div class="hero__container">
            ...
            <button class="main__btn"><a href="allproductindex.php">Explore</a></button>
        </div>
    </div>
    ...
    <div class="main" id="about">
        <div class="main__container">
            ...
            <div class="main__content">
                ...
                <button class="main__btn"><a href="login.php">Sell</a></button>
            </div>
        </div>
    </div>
    ...
    <div class="services" id="services">
        ...
        <div class="services__wrapper">
            <div class="services__card">
                ...
                <div class="services__btn"><a href="electronicsindex.php"><button>Get Started</button></a></div>
            </div>
            <div class="services__card">
                <h2>Clothing</h2>
